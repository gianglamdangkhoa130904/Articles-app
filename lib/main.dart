...
import 'package:final_project/views/home_wrapper.dart';
...
void main() async {
  ...
  final userId = prefs.containsKey('customerId') ? prefs.getString('customerId'): '';
  runApp(MaterialApp(
    debugShowCheckedModeBanner: false,
    home: SafeArea(
      child: hasLogin ? HomeWrapper(userId: userId!,) : const LoginPage()
    ),
  ));
}
